...
<HTML> <!-- Balise de départ de la page HTML --> 
	...
	<H1 align = "center"><u> Visualisation des stocks de Lucas Magasin </U></h1><br> <br>
	<h3> <U>Les stocks</U>
	<table border="1">
	<tr>
		<td>Nom article</td><td>Code Article</td><td>Rangement</td><td> Quantité </td>
	</tr><br><br>
	<?php
		$requete = "SELECT articles.nom AS nom_article, articles.code, rangements.nom AS nom_rangement, quantite FROM stocks JOIN articles ON stocks.article = articles.code JOIN rangements ON stocks.rangement = rangements.id ORDER BY stocks.quantite";
